...
var _jsxFileName = "/Users/marcoellwanger/nextjs/occasio-partners/pages/contact.js";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log("IN GET INITIAL PROP CONTACT"); //const res = await fetch('https://api.github.com/repos/developit/preact')
...
Contact.componentDidMount = function (async) {
  console.log("IN COMPONENTDIDMOUNT CONTACT"); //const res = await fetch('https://api.github.com/repos/developit/preact')
  //const json = await res.json()
